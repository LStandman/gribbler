...
main = do
  ...
  print $ zero_or_more (match_char 'c') "xarl"
  print $ zero_or_more (match_char 'c') "carl"
  print $ zero_or_more (match_char 'c') "ccrl"
  print $ one_or_more (match_char 'c') "xarl"
  print $ one_or_more (match_char 'c') "carl"
  print $ one_or_more (match_char 'c') "ccrl"
  print $ zero_or_one (match_char 'c') "xarl"
  print $ zero_or_one (match_char 'c') "carl"
  print $ zero_or_one (match_char 'c') "ccrl"
  print $ b_break "\n\rccrl"
  print $ b_break "\n\nccrl"
